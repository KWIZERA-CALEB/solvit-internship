...
<head>
    ...
    <title>Login for Admins | User feedback system</title>
...
<body>
    <div class="flex w-full bg-[url('mac2.jpg')] bg-cover bg-center h-[100vh] justify-center items-center">
        <div class="w-[450px] p-[30px] bg-transparent border-solid borderwhite rounded-[20px] border-[3px] backdrop-blur-md">
            <p class="text-start font-bold text-[20px] text-white uppercase">Admin login</p>
            <p class="text-start text-white mt-[20px]">This page is made for only admins to login.</p>
            <!-- form -->
             <div class="mt-[15px]">
                <form action='../includes/login_inc.php' method='POST' class="flex flex-col space-y-[20px]">
                    ...
                    <button type='submit' name='login-btn' class="w-full pr-[20px] pl-[20px] pt-[10px] pb-[10px] rounded-full text-[#000] bg-white outline-none">Login</button>
                </form>
             </div>
            <!-- form -->
        </div>
